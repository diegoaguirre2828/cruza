        ...
        <div className="max-w-2xl mx-auto px-8 py-12">
          ...
          <div className="flex items-start justify-between mb-8 pb-6 border-b border-gray-200">
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xl font-black tracking-tight text-gray-900">CRUZA</span>
                <span className="text-xs font-semibold text-gray-400 uppercase tracking-widest mt-0.5">Border Intelligence</span>
              </div>
              <p className="text-xs text-gray-400">cruzaapp.vercel.app</p>
            </div>
          ...
          <div className="mb-8">
            ...
            <div className="mt-4 border border-gray-200 rounded-xl p-4 bg-gray-50">
              <p className="text-xs text-gray-600 leading-relaxed">
                ...
                Cruza Border Intelligence and reflects official CBP-reported wait times at the time of crossing.
              </p>
            </div>
          </div>
          ...
          <div className="mt-12 pt-4 border-t border-gray-100">
            <p className="text-xs text-gray-300 text-center">
              Generated by Cruza Border Intelligence · cruzaapp.vercel.app · Data sourced from U.S. CBP public API
            </p>
          </div>
        </div>
      </div>
