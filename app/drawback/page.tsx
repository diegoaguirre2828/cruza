...
export const metadata = {
  title: 'US Duty Drawback (§1313) — Cruzar',
  description:
    'Recover 99% of duties, taxes, and fees on imports that were exported, re-exported, or returned. Free §1313 drawback scan. Platform fee: 8% of refund processed, $99 floor.',
  alternates: { canonical: 'https://www.cruzar.app/drawback' },
};

export default async function DrawbackLandingPage({
  searchParams,
}: {
  ...
  const c = lang === 'es' ? DRAWBACK_ES : DRAWBACK_EN;
  ...
  return (
    <div className="dark min-h-screen bg-background text-foreground">
      ...
      <section className="border-b border-border">
        <div className="mx-auto max-w-[1180px] px-5 sm:px-8 py-16">
          <div className="font-mono text-[10.5px] uppercase tracking-[0.2em] text-muted-foreground">
            {c.landing.claim_types.eyebrow}
          </div>
          <div className="mt-8 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            {[
              { t: c.landing.claim_types.manufacturing_direct_title, b: c.landing.claim_types.manufacturing_direct_body },
              { t: c.landing.claim_types.manufacturing_sub_title, b: c.landing.claim_types.manufacturing_sub_body },
              { t: c.landing.claim_types.unused_direct_title, b: c.landing.claim_types.unused_direct_body },
              { t: c.landing.claim_types.unused_sub_title, b: c.landing.claim_types.unused_sub_body },
              { t: c.landing.claim_types.rejected_title, b: c.landing.claim_types.rejected_body },
            ].map((s, i) => (
