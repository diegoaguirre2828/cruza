...
export const metadata = {
  title: 'Free §1313 drawback scan — Cruzar',
  description:
    'Free §1313 drawback eligibility scan. Enter one import + one export; we classify the claim type and estimate your 99% recovery. No signup required.',
  alternates: { canonical: 'https://www.cruzar.app/drawback/scan' },
};

export default async function DrawbackScanPage({
  searchParams,
}: {
