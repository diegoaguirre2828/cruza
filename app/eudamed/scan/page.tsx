...
export const metadata = {
  title: 'Free EUDAMED readiness check — Cruzar',
  description:
    'Free EUDAMED actor + UDI readiness check. Tell us your actor + one device; we tell you what EUDAMED requires and what is missing. No signup required.',
  alternates: { canonical: 'https://www.cruzar.app/eudamed/scan' },
};

export default async function EudamedScanPage({
  searchParams,
}: {
