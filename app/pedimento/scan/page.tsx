...
export const metadata = {
  title: 'Free pedimento scan — Cruzar',
  description:
    'Free pedimento composition check. Enter agent, importer, one merchandise line; we classify the clave, validate identifiers, and compute duties. No signup.',
  alternates: { canonical: 'https://www.cruzar.app/pedimento/scan' },
};

export default async function PedimentoScanPage({
  searchParams,
}: {
