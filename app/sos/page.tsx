...
export default function SosPage() {
  ...
  const t = {
    ...
    fire: lang === 'es' ? 'Activar SOS y avisar a mis contactos' : 'Activate SOS and notify my contacts',
    sentNote: lang === 'es' ? 'SOS activado. Tus contactos recibieron aviso.' : 'SOS activated. Contacts notified.',
