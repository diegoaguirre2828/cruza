...
export const metadata = {
  title: 'Free UFLPA risk scan — Cruzar',
  description:
    'Free UFLPA risk check. Map your supply chain; we flag Xinjiang exposure + Entity List matches. No signup.',
  alternates: { canonical: 'https://www.cruzar.app/uflpa/scan' },
};

export default async function UflpaScanPage({ searchParams }: { searchParams: Promise<{ lang?: string }> }) {
