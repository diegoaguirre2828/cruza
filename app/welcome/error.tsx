...
export default function WelcomeError({ error, reset }: Props) {
    ...
    <main className="min-h-screen bg-gray-50 dark:bg-gray-950 px-4 pt-10">
      <div className="max-w-md mx-auto bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 shadow-sm text-center">
        ...
        <h1 className="text-base font-black text-gray-900 dark:text-gray-100 mb-1">
          No cargó bien la bienvenida · Welcome didn&apos;t load right
        </h1>
        <p className="text-xs text-gray-500 dark:text-gray-400 leading-snug mb-4">
          Reintenta o salta directo al inicio — tu cuenta ya está creada. · Try again or head straight to home — your account is already created.
        </p>
        <div className="flex flex-col gap-2">
          ...
          <Link href="/dashboard" className="w-full py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 text-sm font-semibold">
