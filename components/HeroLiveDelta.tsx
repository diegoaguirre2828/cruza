        ...
        <div className="mt-2 bg-gradient-to-r from-emerald-500 to-green-600 text-white rounded-2xl px-3 py-2.5 shadow-md">
          <div className="flex items-center justify-between gap-2">
            ...
            <a
              ...
              className="cruzar-press-sm flex-shrink-0 inline-flex items-center gap-1 bg-white text-green-700 text-[11px] font-black px-2.5 py-1 rounded-full"
            >
      ...
      <div className="mt-2 flex items-center justify-between gap-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl px-3 py-2">
        ...
        <div className="flex items-center gap-1.5 flex-shrink-0">
          <a
            ...
            aria-label="Facebook"
            className="cruzar-press-sm w-9 h-9 flex items-center justify-center rounded-full bg-[#1877f2] text-white"
          >
          ...
          <a
            ...
            aria-label="WhatsApp"
            className="cruzar-press-sm w-9 h-9 flex items-center justify-center rounded-full bg-[#25d366] text-white"
          >
          ...
          <button
            ...
            className="cruzar-press-sm w-9 h-9 flex items-center justify-center rounded-full bg-gray-900 dark:bg-gray-600 text-white text-sm font-black"
          >
            {copied ? '✓' : '🔗'}
          </button>
        </div>
