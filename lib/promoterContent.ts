...
export const PROMOTER_TEMPLATES: ContentTemplate[] = [
  ...
  // templates above — both matter, they just do different things.
  {
    ...
    text: 'Raza, les dejo la página de Cruzar — publica los tiempos de los puentes 4 veces al día. Si le dan follow, les llega notificación cada mañana antes de salir: cruzar.app/fb',
    translationEn: "Everyone, here's the Cruzar FB page — it posts bridge wait times 4 times a day. If you follow it, you get a notification every morning before you leave: cruzar.app/fb",
  },
  {
    id: 'page-02',
    category: 'page_follow',
    label: '4 horas clave del día',
    text: 'Sigan la página de Cruzar en FB, publica los tiempos en las 4 horas clave: mañana, mediodía, tarde y noche. Les llega notificación directo al teléfono 👉 cruzar.app/fb',
    translationEn: 'Follow the Cruzar FB page — it posts wait times at the 4 key hours: morning, midday, afternoon, and evening. Notifications go straight to your phone 👉 cruzar.app/fb',
  },
  {
    id: 'page-03',
    category: 'page_follow',
    label: 'Para los que se olvidan',
    text: 'Si siempre se les olvida chequear el puente antes de salir, sigan a Cruzar en FB y FB les avisa cuando publican los tiempos. Ahorra horas de fila: cruzar.app/fb',
    translationEn: "If you always forget to check the bridge before leaving, follow Cruzar on FB and FB will notify you when they post the times. Saves you hours in line: cruzar.app/fb",
  },
  {
    id: 'page-04',
    category: 'page_follow',
    label: 'Recomendación directa',
    text: 'Si cruzan seguido, síganse la página de Cruzar. Publica los tiempos de TODOS los puentes, en vivo, cuatro veces al día. Yo ya le di follow y no me arrepiento 👉 cruzar.app/fb',
    translationEn: "If you cross often, follow the Cruzar page. It posts live wait times for EVERY bridge, four times a day. I already followed and I don't regret it 👉 cruzar.app/fb",
  },
  {
    id: 'page-05',
    category: 'page_follow',
    label: 'Doble recomendación (app + página)',
    text: 'Dos cosas que les van a servir si cruzan seguido:\n\n1️⃣ La app: {{refLink}} — tiempos en vivo de todos los puentes\n2️⃣ La página de FB: cruzar.app/fb — notificaciones en las horas clave\n\nLas dos son gratis.',
    translationEn: 'Two things that will help if you cross often:\n\n1️⃣ The app: {{refLink}} — live wait times for every bridge\n2️⃣ The FB page: cruzar.app/fb — notifications at the key hours\n\nBoth are free.',
  },
]
